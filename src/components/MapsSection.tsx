  ...
  useEffect(() => {
    const initMap = async () => {
      const loader = new Loader({
        apiKey: "AIzaSyCEXW1x6XlHJCEkL9-6IAlewgYPILfP5gw",
        version: "weekly",
      });
      ...
      <div className="flex flex-col xl:flex-row gap-10 justify-start items-start">
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-10">
            <div className="flex flex-col gap-4 items-start mx-20">
              <FaBuilding className="text-hijau text-6xl" />
            ...
            <div className="flex flex-col gap-4 items-start mx-20">
              <FaVrCardboard className="text-hijau text-6xl" />
